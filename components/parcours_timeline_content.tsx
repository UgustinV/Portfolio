    ...
    return (
        <>
            <TimelineItem>
                ...
                <TimelineContent>
                    <TimelineTime className="text-xl text-gray-700 dark:text-gray-300">2021 - 2022</TimelineTime>
            ...
            <TimelineItem>
                <TimelinePoint icon={HiAcademicCap} />
                <TimelineContent>
                    <TimelineTime className="text-xl text-gray-700 dark:text-gray-300">2022 - 2023</TimelineTime>
            ...
            <TimelineItem>
                <TimelinePoint icon={HiAcademicCap} />
                <TimelineContent>
                    <TimelineTime className="text-xl text-gray-700 dark:text-gray-300">2023 - 2024</TimelineTime>
            ...
            <TimelineItem>
                <TimelinePoint icon={HiAcademicCap} />
                <TimelineContent>
                    <TimelineTime className="text-xl text-gray-700 dark:text-gray-300">2024 - 2025</TimelineTime>
